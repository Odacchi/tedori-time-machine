...
export function TaxForm({ value, onChange }: Props) {
        ...
        <Card>
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-2">
                    <Label htmlFor="salary">年収（額面・万円）</Label>
                ...
                <div className="flex items-center space-x-2 border p-4 rounded-md">
                    ...
                    />
                    <Label htmlFor="isOver40" className="cursor-pointer font-medium">
                        40歳以上（介護保険料あり）
                    </Label>
                </div>
                ...
                <div className="space-y-2">
                    ...
                    >
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="none" id="sp-none" />
                            <Label htmlFor="sp-none">なし / 共働き（扶養外）</Label>
                        </div>
                        <div className="flex items-center space-x-2">
                            <RadioGroupItem value="dependent" id="sp-dep" />
                            <Label htmlFor="sp-dep">扶養あり</Label>
                        </div>
                    </RadioGroup>
                </div>
                ...
                <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-1">
                            <Label htmlFor="c0" className="text-xs text-muted-foreground">
                                0〜15歳
                            </Label>
                            <Input
                                id="c0"
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="c1" className="text-xs text-muted-foreground">
                                16〜18歳
                            </Label>
                            <Input
                                id="c1"
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="c2" className="text-xs text-muted-foreground">
                                19〜23歳
                            </Label>
                            <Input
                                id="c2"
